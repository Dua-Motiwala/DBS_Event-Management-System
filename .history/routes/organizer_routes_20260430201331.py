...
def create_event():
    if request.method == 'POST':
        ...
        return redirect(url_for('organizer.manage_event', event_id=new_event.eventid))
...
def edit_event(eventid):
    ...
    if request.method == 'POST':
        ...
        event.venueid = request.form.get('venueid')  
        event.categoryid = request.form.get('categoryid')  
