...
def create_app():
    ...
    def event_details(event_id):
        ...
        return render_template('event_details.html', event=event, today=datetime.utcnow().date(), day_delta=timedelta(days=1))
    ...
    def index():
        ...
        return render_template('index.html', events=events, today=datetime.utcnow().date(), day_delta=timedelta(days=1))
