...
def give_feedback(event_id):
    ...
    # Restriction: Only allow feedback for finished events
    if event.status != 'Finished':
        flash('You can only provide feedback once the event is marked as Finished.', 'warning')
        return redirect(url_for('attendee.dashboard'))
    ...
    return render_template('attendee/feedback.html', event_id=event_id, event=event)
